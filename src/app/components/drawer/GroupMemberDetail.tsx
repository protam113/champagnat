    ...
    >
      ...
      <Row className="mt-4">
        <Col span={12}>
          <DescriptionItem
            title="Tên"
            content={member?.name || 'Không có thông tin!'}
            icon={<FaUser />}
          />
        </Col>
        <Col span={12}>
          <DescriptionItem
            title="Email"
            content={member?.email || 'Không có thông tin!'}
            icon={<FaEnvelope />}
          />
        </Col>
      </Row>
      <Row>
        <Col span={12}>
          <DescriptionItem
            title="Số Điện Thoại"
            content={member?.phone_number || 'Không có thông tin!'}
            icon={<FaPhone />}
          />
        </Col>
        <Col span={12}>
          <DescriptionItem
            title="Ngày Tham Gia"
            content={member?.join_date || 'Không có thông tin!'}
            icon={<FaCalendar />}
          />
        </Col>
      </Row>
      ...
      <Row className="mt-4">
        ...
        <Col span={12}>
          <DescriptionItem
            title="Ngày Tạo"
            content={formatDate(member?.created_date)}
            icon={<FaCalendar />}
          />
        </Col>
      </Row>
      <Row>
        <Col span={12}>
          <DescriptionItem
            title="Ngày Cập Nhật"
            content={formatDate(member?.updated_date)}
            icon={<FaCalendar />}
          />
        </Col>
      </Row>
