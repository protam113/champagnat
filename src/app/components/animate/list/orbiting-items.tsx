import { FaChurch,
    ...
    FaCross,
    GiIronCross,
    AiFillHeart } from "@/lib/iconLib"
import { cn } from "@/lib/utils";

export const testOrbitingItems = [
  <FaChurch key="github" className="h-6 w-6" />,
  <PiHandsPrayingBold key="twitter" className="h-6 w-6" />,
  <FaCross key="yarn" className="h-6 w-6" />,
  <GiIronCross key="tailwind" className="h-6 w-6" />,
  <GiIronCross key="framer" className="h-6 w-6" />,
  <AiFillHeart key="apple" className="h-6 w-6" />,
];
